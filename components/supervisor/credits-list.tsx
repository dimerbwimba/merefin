...
import { ArrowRight, CheckCircle, XCircle, Search, UserCircle } from "lucide-react"
...
export function CreditsList({ credits, clients, currentFilters }: CreditsListProps) {
                    ...
                    <td className="py-3 px-4">
                      <div className="flex gap-2">
                        <Button asChild variant="ghost" size="icon" title="Voir les détails">
                          <Link href={`/dashboard/supervisor/credits/${credit.id}`}>
