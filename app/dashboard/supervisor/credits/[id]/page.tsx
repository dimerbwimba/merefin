...
export default async function SupervisorCreditDetailPage({
  params,
}: {
  params: { id: string };
}) {
            ...
            {credit.status === "EN_ATTENTE" && (
              <CardFooter className="flex gap-4">
                <Button asChild variant="default" className="w-full">
                  <Link
                    href={`/dashboard/supervisor/credits/${credit.id}/approve`}
                  >
                ...
                <Button asChild variant="destructive" className="w-full">
                  <Link
                    href={`/dashboard/supervisor/credits/${credit.id}/reject`}
                  >
