...
export default async function CreditDetailsPage({
  params,
}: {
  ...
  const totalRepaid = credit.payments.reduce(
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-lg font-semibold">
                      {credit.amount.toLocaleString("fr-FR")} USD
                    </p>
                  </div>
                  <div>
                    <h3 className="text-sm font-medium text-muted-foreground">
                ...
                <div>
                  ...
                  <div className="border rounded-md p-3 space-y-2">
                    <p className="text-sm font-medium">
                      Type:{" "}
                      {metadata.guaranteeType
                        ? getGuaranteeTypeName(metadata.guaranteeType)
                        : "Non spécifié"}
                    </p>
                    <p className="text-sm">
                      {metadata.guaranteeDescription ||
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      <span>
                        Total remboursé: {totalRepaid.toLocaleString("fr-FR")}{" "}
                        USD
                      </span>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-2">
                      <div>
                        ...
                        <p className="text-sm font-semibold">
                          {metadata.address || "Non spécifiée"}
                        </p>
                      </div>
                      <div>
                        <h3 className="text-sm font-medium text-muted-foreground">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-semibold">
                          {metadata.activityType
                            ? getActivityTypeName(metadata.activityType)
                            : "Non spécifié"}
                        </p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p className="text-sm font-semibold">
                          {metadata.monthlyIncome
                            ? `${metadata.monthlyIncome.toLocaleString(
                                "fr-FR"
                              )} USD`
                            : "Non spécifié"}
                        </p>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-semibold">
                          {metadata.acceptFees === true
                            ? "Accepte de payer les frais de dossier"
                            : "Non accepté"}
                        </p>
                      </div>
                    </CardContent>
              ...
              <TabsContent value="documents" className="space-y-4">
                <div className="bg-muted p-4 rounded-md">
                  ...
                  <ul className="space-y-2 text-sm">
                    ...
                    <li className="flex items-center space-x-2">
                      ...
                      <span>
                        Preuve de revenus: À vérifier lors de la visite
                      </span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <div className="h-2 w-2 rounded-full bg-yellow-500"></div>
                ...
                <div className="border rounded-md p-4">
                  <h3 className="font-medium mb-2">
                    Actions recommandées avant approbation
                  </h3>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center space-x-2">
                      <Calendar className="h-4 w-4 text-muted-foreground" />
                      <span>
                        Planifier une visite pour vérifier l'activité
                    ...
                    <li className="flex items-center space-x-2">
                      <Shield className="h-4 w-4 text-muted-foreground" />
                      <span>
                        Vérifier la garantie proposée:{" "}
                        {metadata.guaranteeDescription || "Non spécifiée"}
                      </span>
                    </li>
                    <li className="flex items-center space-x-2">
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {credit.payments.length} paiement(s) enregistré(s)
              </CardDescription>
            </CardHeader>
            <CardContent>
                      ...
                      <div className="flex justify-between items-center">
                        <div>
                          <p className="font-medium">
                            {payment.amount.toLocaleString("fr-FR")} USD
                          </p>
              ...
              <AccordionContent>
                <div className="space-y-2">
                  {credit.status === "EN_ATTENTE" && (
                    <>
                      ...
                      <Button variant="outline" className="w-full" asChild>
                        <Link
                          href={`/dashboard/admin/credits/${credit.id}/reject`}
                        >
                  ...
                  {credit.status === "APPROUVE" && (
                    <Button className="w-full" asChild>
                      <Link
                        href={`/dashboard/admin/credits/${credit.id}/payment`}
                      >
                        <CheckCircle className="h-4 w-4 mr-2" />
                        Enregistrer un paiement
                      </Link>
                  ...
                  <Button variant="outline" className="w-full" asChild>
                    <Link
                      href={`/dashboard/admin/users/${credit.userId}/edit`}
                    >
